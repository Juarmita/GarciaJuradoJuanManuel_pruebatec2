    ...
    public void create(Ciudadano ciudadano) {
        ...
        try {
            ...
            for (Turno listaTurnosTurnoToAttach : ciudadano.getListaTurnos()) {
                listaTurnosTurnoToAttach = em.getReference(listaTurnosTurnoToAttach.getClass(), listaTurnosTurnoToAttach.getNumTurno());
    ...
    public void edit(Ciudadano ciudadano) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Turno listaTurnosNewTurnoToAttach : listaTurnosNew) {
                listaTurnosNewTurnoToAttach = em.getReference(listaTurnosNewTurnoToAttach.getClass(), listaTurnosNewTurnoToAttach.getNumTurno());
